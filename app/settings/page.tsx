...
const sections = [
  {
    title: 'Account',
    description: 'Manage your profile details, handle, and email address.',
  },
  {
    title: 'Preferences',
    description: 'Personalise your experience — display options, notifications, and more.',
  },
]
      ...
      <div className="max-w-[700px] mx-auto px-5 md:px-10 py-6">
        ...
        <div className="space-y-4">
          {sections.map(({ title, description }) => (
            ...
            >
              <h2 className="font-serif text-lg text-stone-900 mb-1">{title}</h2>
